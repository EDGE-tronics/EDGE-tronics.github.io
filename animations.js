...
export function updateModel(){
  switch(robot.body.model){
    case LSS_Robot_Model.DeskPet:
      body = loadModel("../mechdog_interface/data/deskpet/body.obj");
      shoulder = loadModel("../mechdog_interface/data/deskpet/shoulder.obj");
      knee = loadModel("../mechdog_interface/data/deskpet/shoulder-knee.obj");
      leg_right = loadModel("../mechdog_interface/data/deskpet/lower-leg-right.obj");
      leg_left = loadModel("../mechdog_interface/data/deskpet/lower-leg-left.obj");
      robot.updateModel(LSS_Robot_Model.DeskPet);
      break;
    case LSS_Robot_Model.MechDog:
      body = loadModel("../mechdog_interface/data/mechdog/body.obj");
      shoulder = loadModel("../mechdog_interface/data/mechdog/leg-a.obj");
      knee_right = loadModel("../mechdog_interface/data/mechdog/leg-b.obj");
      knee_left = loadModel("../mechdog_interface/data/mechdog/leg-b2.obj");
      leg_right = loadModel("../mechdog_interface/data/mechdog/leg-c.obj");
      leg_left = loadModel('../mechdog_interface/data/mechdog/leg-c2.obj');
